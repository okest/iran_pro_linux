...
#define HW_DESC_SET_DIN_TYPE(pDesc, dmaMode, dinAdr, dinSize, axiId, axiNs)										\
	do {		                                                                                        					\
		...
		DX_CC_REG_FLD_SET(CRY_KERNEL, DSCRPTR_QUEUE0_WORD0, VALUE, (pDesc)->word[0], (dinAdr));				\
...
#define HW_DESC_SET_MULTI2_ROUND(pDesc, roundNum)										\
	do {		                                                                                        		\
		DX_CC_REG_FLD_SET(CRY_KERNEL, DSCRPTR_QUEUE0_WORD2, VALUE, (pDesc)->word[2], (uint32_t)(roundNum));		\
	} while (0)
