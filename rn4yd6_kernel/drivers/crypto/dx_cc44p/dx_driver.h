...
#define DX_CC_HAS_CMAC 0
#include "secure_key_defs.h"
#include "secure_key_int_defs.h"
#elif (DX_DEV_SIGNATURE == DX_CC442P_LT_SIG)
#define DX_DEV_NAME_STR "CC442P-LT"
#define DX_CC_HAS_ROM 0
#define DX_CC_HAS_SEC_KEY 0
#define DX_CC_HAS_AES_CCM 0
#define DX_CC_HAS_AES_XTS 0
#define DX_CC_HAS_AES_CTS 0
#define DX_CC_HAS_MULTI2 0
...
#ifdef DX_DEBUG
#define DX_LOG_DEBUG(format, ...) DX_LOG(KERN_INFO, format, ##__VA_ARGS__)
