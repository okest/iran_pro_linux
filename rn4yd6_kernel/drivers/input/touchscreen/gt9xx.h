...
#define LINUX_PLATFORM //hy add 

//***************************PART1:ON/OFF define*******************************
#define GTP_CUSTOM_CFG        0	   
#define GTP_CHANGE_X2Y        1 //hy 0	   //swap x y
#define GTP_DRIVER_SEND_CFG   1	   //driver send config
#define GTP_HAVE_TOUCH_KEY    1 //hy 0
...
//800*480 50Hz add by hawayi for RN4Y56(LINUX_PLATFORM)
#define CTP_CFG_GROUP3 {\
	0x43,0xE0,0x01,0x20,0x03,0x05,0x05,0x01,0x01,0x08,0x28,0x05,\
	0x50,0x32,0x03,0x0F,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x8C,0x0E,0x0D,0x1B,0x19,0xF4,0x0A,0x00,0x00,\
	0x00,0x9B,0x04,0x1C,0x00,0x00,0x00,0x00,0x00,0x03,0x64,0x32,\
	0x00,0x00,0x00,0x11,0x73,0x94,0xC5,0x02,0x07,0x00,0x00,0x04,\
	0x9E,0x14,0x00,0x6C,0x1E,0x00,0x4B,0x2D,0x00,0x36,0x41,0x00,\
	0x28,0x60,0x00,0x28,0x20,0x18,0x10,0x08,0xF0,0x4A,0x3A,0xFF,\
	...
	0x0A,0x08,0x06,0x04,0x02,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,\
...
#define GTP_RST_PORT    (369)
#define GTP_INT_PORT    (370)
#else
...
#if defined(LINUX_PLATFORM)
	#define GTP_KEY_TAB  {KEY_EJECTCD, KEY_HOMEPAGE, KEY_BACK, KEY_MENU}
#else
